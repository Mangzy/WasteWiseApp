...
import com.example.wastewise.databinding.CardArticleLoadingBinding
...
class LoadingStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<LoadingStateAdapter.LoadingStateViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val binding = CardArticleLoadingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return LoadingStateViewHolder(binding, retry)
    }

    class LoadingStateViewHolder(private val binding: CardArticleLoadingBinding, retry: () -> Unit) :
